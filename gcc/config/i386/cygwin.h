...
{ "no-win32",		  -MASK_WIN32, "Don't set Windows defines" }, \
...
#define CPP_PREDEFINES "-Di386 -D_X86=1 -D__STDC__=1 \
...
/* As noted above, cygwin does not need a separate math library. */
#define MATH_LIBRARY ""
